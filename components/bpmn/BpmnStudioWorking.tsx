...
export function BpmnStudioWorking() {
  ...
  useEffect(() => {
    console.log('BpmnStudioWorking: useEffect started')
    ...
    try {
      console.log('Creating BpmnModeler...')
      
      // Create modeler with diagram-js modules
      ...
      console.log('Modeler created:', modeler)
      ...
      setError(`Failed to create modeler: ${err instanceof Error ? err.message : String(err)}`)
      setStatus('Failed to initialize')
    }
    
    return () => {
      console.log('Cleanup: destroying modeler')
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      {/* Canvas - This is where bpmn-js and diagram-js render */}
      <div 
        ref={containerRef} 
